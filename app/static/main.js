...
var vueApp = new Vue({
  ...
  methods: {
	...
	async cu_graphrefinement() {
      if (this.new_grefinement != '') {
		r = await postRequest('/create/grefinement', {
					   ...
					   selected_graph: this.selected_graph['value'],
	...
	async d_graphrefinement()  {
	  ...
	  r = await getRequest('/remove/grefinement', {selected_grefinement: this.selected_grefinement['value']})
        }
